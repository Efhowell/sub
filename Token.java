...
public class Token {
    ...
    public static String[] keywords =  { ",", "{", "}", "(", ")", "=", "print", "if", "noelse", "while"};
    public static String[] unaryOps =  { "not" };    
    public static String[] binaryOps = { "+", "~", "*", "/", "%", "^", "and", "or", "==", "!=", ">", ">=", "<", "<=" }; 
    public static String[] booleans =  { "true", "false" };
